...
From `site/public/benchmarks.json` (generated by `ninja bench`):
- Date (UTC): `2026-02-23T05:21:13.042Z`
- Binary size: `36.63 KB` (37,504 bytes)
- Peak RSS: `5552 KB` (5,685,248 bytes)
- Startup (`--help`, hyperfine mean): `6.759 ms`
